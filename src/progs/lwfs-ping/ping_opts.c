/*
  ...
  /usr/bin/gengetopt -S --set-package=lwfs --set-version=0.1 -F ping_opts 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --server-nid=INT  NID of the service to ping  (default=`0')",
  "      --server-pid=INT  PID of the service to ping  (default=`0')",
